...
training_data = [
    ...
    ("Prepare the grill".split(), ["V", "DET", "NN"]),
    ("Cook the peppers on the grill and give the skin a little charring".split(), ["V", "DET", "NN", "NN", "NN", "NN", "DET", "V", "DET", "NN", "NN", "NN", "NN"]),
]
word_to_ix = {}
...
#     inputs = prepare_sequence("slice the peppers", word_to_ix)
